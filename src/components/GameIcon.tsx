...
export default function GameIcon({ game, stats, onClick, index }: GameIconProps) {
  return (
    ...
    >
      <div
        className={`game-icon w-16 h-16 sm:w-[72px] sm:h-[72px] bg-gradient-to-br ${game.gradient} flex items-center justify-center shadow-lg`}
      >
        <span className="text-3xl sm:text-[34px] select-none leading-none">{game.emoji}</span>
